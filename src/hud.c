...
void hudRender(){
	...
	snprintf(statusLine,STATUSLINE_MAX_CHARS,"Level: %i Hp: %i/%i Exp: %i Level: %i",playerGetInfo()->pos.z,playerGetInfo()->hp,playerGetInfo()->maxhp,playerGetInfo()->exp,playerGetInfo()->level);
